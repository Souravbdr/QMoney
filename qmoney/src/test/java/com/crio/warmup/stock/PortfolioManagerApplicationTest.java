...
class PortfolioManagerApplicationTest {
  ...
  void mainCalculateAnnualReturn() throws Exception {
    ...
    Assertions.assertEquals(0.752, result.get(0).getAnnualizedReturn(), 0.01);
    Assertions.assertEquals(0.539, result.get(1).getAnnualizedReturn(), 0.01);
    Assertions.assertEquals(0.312, result.get(2).getAnnualizedReturn(),0.01);
  ...
  public void testCalculateAnnualizedReturn() {
    ...
    Assertions.assertEquals(0.024,returns.getAnnualizedReturn(), 0.001);
  }
  ...
  public void testCalculateAnnualizedReturnGoogl() {
    ...
    Assertions.assertEquals(0.278,returns.getAnnualizedReturn(), 0.02);
  }
